...
app.config['MYSQL_PASSWORD'] = 'localhost@22'
...
def login():
    ...
    if request.method == 'POST' and 'username' in request.form and 'password' in request.form:
        ...
        if account:
            ...
            webbrowser.open('E:/New folder/dbms mini/grocery_store/Grocery-Store-Management-System-main-22_01/templates/index.html')
        else:
